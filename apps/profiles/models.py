...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+254797702066"
    )
    about_me = models.TextField(
        verbose_name=_("About Me"), default="Say something else about you"
    )
    ...
    country = CountryField(
        verbose_name=("Country"), default="KE", blank=False, null=False
    )
