# interface through which db query operations are provided.
...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(
        ...
        if not first_name:
            raise ValueError(_("Provide a valid first name"))

        if not last_name:
            raise ValueError(_("Provide a valid last name"))
    ...
    def create_superuser(
        ...
        if not password:
            raise ValueError(_("Valid password must be provided"))
